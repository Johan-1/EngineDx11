...
SponzaTestScene::SponzaTestScene()
{
	...
	//sponza->AddComponent<ModelComponent>()->InitModel("Data/Models/sponza.obj", STANDARD | CAST_SHADOW_DIR | CAST_REFLECTION, L"Data/Textures/marble.dds", L"", L"", L"", true, 1);
	...
	//smallSphereLight->AddComponent<ModelComponent>()->InitModel("Data/Models/sphere.obj", STANDARD | CAST_SHADOW_DIR | CAST_REFLECTION, L"", L"", L"", L"Data/Textures/emissiveTest.dds");
	...
	//bar->AddComponent<ModelComponent>()->InitModel("Data/Models/cube.obj", STANDARD | CAST_SHADOW_DIR | CAST_REFLECTION, L"", L"", L"", L"Data/Textures/emissiveOrange.dds");
	...
	//bar2->AddComponent<ModelComponent>()->InitModel("Data/Models/cube.obj", STANDARD | CAST_SHADOW_DIR | CAST_REFLECTION, L"", L"", L"", L"Data/Textures/emissiveOrange.dds");
	...
	//BigSphereLight1->AddComponent<ModelComponent>()->InitModel("Data/Models/sphere.obj", STANDARD | CAST_SHADOW_DIR | CAST_REFLECTION, L"", L"", L"", L"Data/Textures/emissivePurple.dds");
	...
	//BigSphereLight2->AddComponent<ModelComponent>()->InitModel("Data/Models/sphere.obj", STANDARD | CAST_SHADOW_DIR | CAST_REFLECTION, L"", L"", L"", L"Data/Textures/emissiveRed.dds");
	...
	//BigSphereLight3->AddComponent<ModelComponent>()->InitModel("Data/Models/sphere.obj", STANDARD | CAST_SHADOW_DIR | CAST_REFLECTION, L"", L"", L"", L"Data/Textures/emissiveBlue.dds");
	...
	//BigSphereLight4->AddComponent<ModelComponent>()->InitModel("Data/Models/sphere.obj", STANDARD | CAST_SHADOW_DIR | CAST_REFLECTION, L"", L"", L"", L"Data/Textures/emissivePink.dds");
 ...
 //	Entity* POM = new Entity();
	...
	//POM->AddComponent<ModelComponent>()->InitModel("Data/Models/plane.obj", STANDARD, L"Data/Textures/Stone1.dds", L"Data/Textures/stone1Normal_H.dds", L"", L"", false, 3, 0.15f);

	//Entity* noPOM = new Entity();
	//noPOM->AddComponent<TransformComponent>()->Init(XMFLOAT3(0, 0.1f, 60), XMFLOAT3(0, 0, 0), XMFLOAT3(3, 1, 3));
	//noPOM->AddComponent<ModelComponent>()->InitModel("Data/Models/plane.obj", STANDARD, L"Data/Textures/Stone1.dds", L"Data/Textures/stone1Normal.dds", L"", L"", false, 3);
