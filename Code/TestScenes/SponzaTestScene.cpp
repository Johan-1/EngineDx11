...
SponzaTestScene::SponzaTestScene()
{
	...
	floor->AddComponent<ModelComponent>()->InitModel("Data/Models/plane.obj", ALPHA_REFLECTION | REFRACT, L"Data/Textures/sponza_floor_a_diff.dds", L"Data/Textures/sponza_floor_a_ddn.dds", L"Data/Textures/FlatHighSpecular.dds", L"", false, 800.0f);
	...
	water->AddComponent<ModelComponent>()->InitModel("Data/models/waterPlane.obj", ALPHA_WATER, L"", L"Data/Textures/waterNormal.dds", L"Data/Textures/FlatHighSpecular.dds", L"", false, 3.0f);;
	...
	// water pillar model
	InstancedModel* waterPillars = new InstancedModel("Data/Models/cube.obj", INSTANCED_OPAQUE | INSTANCED_CAST_SHADOW_DIR | INSTANCED_CAST_REFLECTION);
	...
	InstancedModel* waterBulbs = new InstancedModel("Data/Models/sphere.obj", INSTANCED_OPAQUE | INSTANCED_CAST_SHADOW_DIR | INSTANCED_CAST_REFLECTION, L"", L"", L"", L"Data/Textures/emissiveOrange.dds");
	...
	// fire place models
	InstancedModel* firePlaces = new InstancedModel("Data/Models/fogata1.obj", INSTANCED_OPAQUE | INSTANCED_CAST_SHADOW_DIR | INSTANCED_CAST_REFLECTION);
